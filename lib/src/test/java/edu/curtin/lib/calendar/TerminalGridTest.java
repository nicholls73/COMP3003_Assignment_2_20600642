package edu.curtin.lib.calendar;

import org.junit.jupiter.api.*;
import org.junit.jupiter.params.*;
import org.junit.jupiter.params.provider.*;

import edu.curtin.calendar.lib.TerminalGrid;
...
class TerminalGridTest {
    ...
    void test1x2Wrapped2ndCol() {
        // It should be the second column that gets squashed, because it's wider (and
        // still wider
    ...
    void test1x2WrappedAllCols() {
        // Both columns should end up squashed to the same width (because squashing only
        // the
    ...
    void test3x2SquashLimit(int terminalWidth) {
        // TerminalGrid should refuse to squash columns down below one character wide,
        // even if this
